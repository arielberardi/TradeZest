...
std::string Broker::FetchAccountId() const
{
    ...
    http::status result = HTTPRequest::Instance().Make(boost::urls::url{m_Endpoint + "/accounts"},
                                                       http::verb::get,
                                                       m_Headers,
                                                       body,
                                                       response);
...
boost::json::object Broker::GetAccountDetails() const
{
    ...
    http::status result =
        HTTPRequest::Instance().Make(boost::urls::url{m_EndpointWithID}, http::verb::get, m_Headers, body, response);
...
boost::json::array Broker::GetOrders() const
{
    ...
    http::status result = HTTPRequest::Instance().Make(boost::urls::url{m_EndpointWithID + "/orders"},
                                                       http::verb::get,
                                                       m_Headers,
                                                       body,
                                                       response);
...
boost::json::array Broker::GetPendingOrders() const
{
    ...
    http::status result = HTTPRequest::Instance().Make(boost::urls::url{m_EndpointWithID + "/pendingOrders"},
                                                       http::verb::get,
                                                       m_Headers,
                                                       body,
                                                       response);
...
boost::json::object Broker::GetOrder(const std::string &orderId) const
{
    ...
    http::status result = HTTPRequest::Instance().Make(boost::urls::url{m_EndpointWithID + "/orders/" + orderId},
                                                       http::verb::get,
                                                       m_Headers,
                                                       body,
                                                       response);
...
bool Broker::CancelOrder(const std::string &orderId) const
{
    ...
    http::status result =
        HTTPRequest::Instance().Make(boost::urls::url{m_EndpointWithID + "/orders/" + orderId + "/cancel"},
                                     http::verb::put,
                                     m_Headers,
                                     body,
                                     response);
...
boost::json::object Broker::GetPosition(const std::string &instrument) const
{
    ...
    http::status result = HTTPRequest::Instance().Make(boost::urls::url{m_EndpointWithID + "/positions/" + instrument},
                                                       http::verb::get,
                                                       m_Headers,
                                                       body,
                                                       response);
...
boost::json::array Broker::GetOpenPositions() const
{
    ...
    http::status result = HTTPRequest::Instance().Make(boost::urls::url{m_EndpointWithID + "/openPositions"},
                                                       http::verb::get,
                                                       m_Headers,
                                                       body,
                                                       response);
...
bool Broker::ClosePosition(const std::string &instrument) const
{
    ...
    http::status result =
        HTTPRequest::Instance().Make(boost::urls::url{m_EndpointWithID + "/positions/" + instrument + "/close"},
                                     http::verb::put,
                                     m_Headers,
                                     body,
                                     response);
...
boost::json::object Broker::GetPricing(const std::string &instrument) const
{
    ...
    http::status result = HTTPRequest::Instance().Make(url, http::verb::get, m_Headers, body, response);
...
boost::json::array Broker::GetCandles(const std::string &instrument,
